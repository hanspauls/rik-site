...
<?php 
$seletedPage = 'pending-checkout-orders';
include_once "include/sidebar.php"; 

$ordersAll = $adminObj->getOrders(1);
//print_r($ordersAll);
?>
						...
						<div class='questions-list'>
							...
							<table width='100%' cellpadding='0' cellspacing='0' class='question-table'>
								...
								<tr>
									...
									<td class='col3'>
										<div class='right'>
                                        <a href="order-detail.php?order=<?php echo $orderNumb ?>" onclick="document.location.href='order-detail.php?order=<?php echo $orderNumb ?>';" title="Order Details" class=""> Details </a> 
