...
<?php 
$seletedPage = 'cancelled-orders';
include_once "include/sidebar.php"; 

$ordersAll = $adminObj->getOrders(3);
//print_r($ordersAll);
?>
							...
							<table width='100%' cellpadding='0' cellspacing='0' class='question-table'>
								...
								<tr>
									...
									<td class='col3'>
                                        ...
                                        <a href="" class='option-delete' onClick="return confirm('Are you sure you want to cancel this order?')" title="Cancel Order">&ensp;</a>
                                        </div>
									</td>
								</tr>
                                <?php endforeach; ?>
