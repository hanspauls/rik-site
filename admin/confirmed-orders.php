...
$ordersAll = $adminObj->getOrders(2);
//print_r($ordersAll);
?>
							...
							<table width='100%' cellpadding='0' cellspacing='0' class='question-table'>
								...
								<tr>
									...
									<td class='col3'>
                                        ...
                                        <a href="shipping-status.php?order=<?php echo $orderNumb ?>" onclick="document.location.href='order-detail.php?order=<?php echo $orderNumb ?>';" title="Change the shipping status or Cancel" class="" style="font-size:15px;"> Edit Shipping Status </a> 
                                        </div>
									</td>
								</tr>
                                <?php endforeach; ?>
