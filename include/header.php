                    ...
                    <div class="col-md-12">
                        ...
                        <div id="menu">
                            <ul class="clearfix">
                                ...
                                <li <?php if(isset($wrapperClass) and $wrapperClass == "order-page")echo 'class="current"' ?>><a href="<?php echo SITE_URL; ?>order.php">Track Order</a></li>
                                ...
                                <?php endif; ?>
                                <li><a data-toggle="modal" data-target="#calculatorModal">العربية</a></li>
                            </ul>
                        </div>
                        <!-- End Menu -->
                    </div>
